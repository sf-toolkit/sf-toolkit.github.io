...
export declare const disabledRules: string[];
/**
 ...
 */
export declare function adaptA11yConfigCustomRules(config: A11yConfig, customRules: string[]): A11yConfig;
/**
 * Adapt a11y config to report only incomplete results
 */
export declare function adaptA11yConfigIncompleteResults(config: A11yConfig): A11yConfig;
/**
 * Adapt a11y config by filtering out disabled rules
 */
export declare function adaptA11yConfig(config: A11yConfig, filterRules?: string[]): A11yConfig;
/**
