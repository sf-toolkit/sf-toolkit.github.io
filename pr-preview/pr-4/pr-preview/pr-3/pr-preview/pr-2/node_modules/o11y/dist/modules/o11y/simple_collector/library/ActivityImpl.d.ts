...
export declare class ActivityImpl implements Activity {
    ...
    constructor(_name: string, _rootId: string, _onStopped: onActivityStop, _onError: onActivityError, timeout?: number, id?: string, _isSampled?: boolean, _startPerfTime?: number, _noRerooting?: boolean);
    get id(): string;
    getId(): string;
    getRootId(): string;
