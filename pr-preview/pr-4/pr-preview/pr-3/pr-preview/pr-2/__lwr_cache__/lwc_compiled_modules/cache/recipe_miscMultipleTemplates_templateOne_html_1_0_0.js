...
import _implicitStylesheets from "./templateOne.css";

import _implicitScopedStylesheets from "./templateOne.scoped.css?scoped=true";

import _uiButton from "ui/button";
import _recipeViewSource from "recipe/viewSource";
import _uiCard from "ui/card";
import {parseFragment, registerTemplate} from "lwc";
const $fragment1 = parseFragment`<div${3}>Template One</div>`;
const stc0 = {
  props: {
...
tmpl.stylesheetToken = "lwc-21rf44gpktr";
tmpl.legacyStylesheetToken = "recipe-miscMultipleTemplates_templateOne";
freezeTemplate(tmpl);
