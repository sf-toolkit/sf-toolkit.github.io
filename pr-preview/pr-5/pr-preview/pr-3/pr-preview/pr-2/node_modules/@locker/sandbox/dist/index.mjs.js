...
toSafeMap$1$LWS(new MapCtor$1$LWS());
...
function proxyMaskFunctionDistortion$LWS({
  ...
  if (LOCKER_VERBOSE_INSTRUMENTATION_FLAG$LWS) {
    ...
    activityName$LWS = factoryName$LWS ? ReflectApply$1$LWS(StringProtoReplace$LWS, factoryName$LWS, [LOCKER_IDENTIFIER_MARKER$LWS, '']) : '<unknown>';
  }
...
function createEvalHelpersFactoryArgs$LWS(record$LWS) {
  ...
  function loadScript$LWS(_thisArg$LWS, url$LWS) {
    ...
    for (let i$LWS = 0, {
      ...
      // istanbul ignore else: current tests have no way of expressing a state that would cause this condition to evaluate false
      if (status$LWS && ReflectApply$1$LWS(scriptSrcGetterDistortion$LWS, script$LWS, []) === resolvedURL$LWS) {
    ...
    ReflectApply$1$LWS(scriptSrcSetterDistortion$LWS, script$LWS, [urlAsString$LWS]);
  ...
  function loadStyle$LWS(_thisArg$LWS, url$LWS) {
    const urlAsString$LWS = toString$LWS(url$LWS);
    let link$LWS = ReflectApply$1$LWS(ElementProtoQuerySelector$LWS, head$LWS, [`link[href=${enquote$LWS(urlAsString$LWS)}]`]);
    if (link$LWS) {
