...
exports.resultsProcessorManualChecks = exports.resultsProcessor = exports.createA11yErrorElements = void 0;
 ...
 */
function createA11yErrorElements(errorElements) {
    const a11yErrorElements = [];
    let onlyOneSummary = false;
    const appendRelatedNodes = (errorMessage, relatedNodes) => {
...
exports.createA11yErrorElements = createA11yErrorElements;
/**
 * Create a test failure violation error message grouped by rule violation
 */
function createA11yRuleViolation(a11yRule, ruleIndex) {
 ...
 */
function processA11yDetailsAndMessages(error, a11yFailureMessages) {
    const a11yRuleViolations = {};
    let a11yRuleViolationsCount = 0;
    let a11yErrorElementsCount = 0;
    error.a11yResults.forEach((a11yResult) => {
        a11yErrorElementsCount++;
        if (!a11yRuleViolations[a11yResult.wcag]) {
