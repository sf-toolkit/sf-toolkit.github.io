...
exports.getA11yConfig = exports.adaptA11yConfig = exports.adaptA11yConfigIncompleteResults = exports.adaptA11yConfigCustomRules = exports.filterRulesByPriority = exports.getPriorityFilter = exports.disabledRules = exports.defaultWcagVersion = exports.defaultPriority = exports.priorities = exports.wcagLevels = void 0;
 ...
 */
function adaptA11yConfigCustomRules(config, customRules) {
...
exports.adaptA11yConfigCustomRules = adaptA11yConfigCustomRules;
/**
 * Adapt a11y config to report only incomplete results
 */
function adaptA11yConfigIncompleteResults(config) {
    const adaptedConfig = JSON.parse(JSON.stringify(config));
    adaptedConfig.reporter = 'v2';
    adaptedConfig.resultTypes = ['incomplete'];
    return adaptedConfig;
}
exports.adaptA11yConfigIncompleteResults = adaptA11yConfigIncompleteResults;
/**
