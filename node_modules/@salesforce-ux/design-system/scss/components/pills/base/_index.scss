...
.slds-pill {
  ...
  &:focus {
    ...
    --slds-c-pill-shadow: var(--sds-c-pill-shadow-focus, var(--slds-g-shadow-outset-focus-1, #{$shadow-button-focus}));
...
.slds-pill__action {
  ...
  padding-right: calc(#{$square-icon-xx-small-boundary} + var(--slds-c-pill-spacing-inline-end, var(--sds-c-pill-spacing-inline-end, #{$spacing-xxx-small})) + 6px);
  ...
  &:focus {
    box-shadow: var(--slds-c-pill-action-shadow, var(--sds-c-pill-action-shadow, var(--slds-g-shadow-outset-focus-1, #{$shadow-button-focus})));
    outline: 0;
  }
}
