...
.slds-split-view__list-item-action[aria-current="page"]:focus {
  -webkit-box-shadow: inset 4px 0 0 #0176d3, 0 0 0 2px var(--slds-g-color-brand-base-40, #0b5cab) inset,
    0 0 0 4px var(--slds-g-color-neutral-base-100, white) inset;
  box-shadow: inset 4px 0 0 #0176d3, 0 0 0 2px var(--slds-g-color-brand-base-40, #0b5cab) inset,
    0 0 0 4px var(--slds-g-color-neutral-base-100, white) inset;
}
