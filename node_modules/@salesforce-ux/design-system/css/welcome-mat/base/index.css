...
.slds-welcome-mat__tile:not(.slds-welcome-mat__tile_complete):not(.slds-welcome-mat__tile_info-only) {
  -webkit-box-shadow: 0 2px 2px var(--slds-g-color-neutral-10-opacity-10, rgba(0, 0, 0, 0.05));
  box-shadow: 0 2px 2px var(--slds-g-color-neutral-10-opacity-10, rgba(0, 0, 0, 0.05));
