...
.slds-tree [role="treeitem"][aria-selected="true"]:focus > .slds-tree__item {
  -webkit-box-shadow: #1b96ff 4px 0 0 inset, 0 0 0 2px var(--slds-g-color-neutral-base-100, white),
    0 0 0 4px var(--slds-g-color-brand-base-40, #0b5cab);
  box-shadow: #1b96ff 4px 0 0 inset, 0 0 0 2px var(--slds-g-color-neutral-base-100, white),
    0 0 0 4px var(--slds-g-color-brand-base-40, #0b5cab);
}
