...
[kx-scope="button"][kx-type="underline"] {
  ...
  --slds-kx-button-underline-base-y: 600%;
  --slds-kx-button-underline-offset-y: 0.25rem;
  --slds-kx-button-underline-translate-y: calc(
    var(--slds-kx-button-underline-base-y) + var(--slds-kx-button-underline-offset-y)
  );
...
[kx-scope="button"][kx-type="underline"]:after {
  ...
  bottom: 50%;
  height: 0.0625rem;
  width: calc(100% - var(--slds-c-button-spacing-inline-start, 0rem) - var(--slds-c-button-spacing-inline-end, 0rem));
  background: var(--slds-c-button-text-color-hover, var(--sds-c-button-text-color-hover, #014486));
  background-position: left top;
  -webkit-transform: scaleX(var(--slds-kx-button-underline-scale-x))
    translateY(var(--slds-kx-button-underline-translate-y));
...
[kx-scope^="button-"][kx-type="ripple"]:after {
  ...
  left: calc(var(--slds-kx-button-pointer-position-x, 50%) - var(--slds-kx-button-ripple-size, 1.25rem) / 2);
  top: calc(var(--slds-kx-button-pointer-position-y, 50%) - var(--slds-kx-button-ripple-size, 1.25rem) / 2);
  border-radius: 50%;
  opacity: 0;
}
