...
.slds-pill {
  ...
  max-width: 100%;
  padding-top: var(--slds-c-pill-spacing-block-start, var(--sds-c-pill-spacing-block-start, 0));
  padding-right: var(--slds-c-pill-spacing-inline-end, var(--sds-c-pill-spacing-inline-end, 0));
  padding-bottom: var(--slds-c-pill-spacing-block-end, var(--sds-c-pill-spacing-block-end, 0));
...
.slds-pill:focus {
  ...
  --slds-c-pill-shadow: var(--sds-c-pill-shadow-focus, var(--slds-g-shadow-outset-focus-1, 0 0 3px #0176d3));
  outline: 0;
}
.slds-pill a {
...
.slds-pill .slds-pill__remove:focus {
  -webkit-box-shadow: var(--slds-g-shadow-inset-inverse-focus-1);
...
.slds-pill_container .slds-listbox-item .slds-pill:focus {
  -webkit-box-shadow: var(--slds-g-shadow-inset-focus-1);
...
.slds-pill__label:focus {
  ...
  -webkit-box-shadow: var(
    ...
    var(--sds-c-pill-label-shadow-focus, var(--slds-g-shadow-outset-focus-1, 0 0 3px #0176d3))
  );
  box-shadow: var(
    --slds-c-pill-label-shadow-focus,
    var(--sds-c-pill-label-shadow-focus, var(--slds-g-shadow-outset-focus-1, 0 0 3px #0176d3))
...
.slds-pill__action {
  ...
  padding-right: calc(
    1rem + var(--slds-c-pill-spacing-inline-end, var(--sds-c-pill-spacing-inline-end, 0.125rem)) + 6px
  );
...
.slds-pill__action:focus {
  -webkit-box-shadow: var(
    ...
    var(--sds-c-pill-action-shadow, var(--slds-g-shadow-outset-focus-1, 0 0 3px #0176d3))
  );
  box-shadow: var(
    --slds-c-pill-action-shadow,
    var(--sds-c-pill-action-shadow, var(--slds-g-shadow-outset-focus-1, 0 0 3px #0176d3))
