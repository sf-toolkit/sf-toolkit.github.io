...
.slds-input:focus {
  --slds-c-input-shadow: var(--slds-c-input-shadow-focus, var(--slds-g-shadow-outline-focus-1, 0 0 3px #0176d3));
...
.slds-input_bare:focus {
  -webkit-box-shadow: var(--slds-g-shadow-inset-inverse-focus-1, 0 0 3px #0176d3);
  box-shadow: var(--slds-g-shadow-inset-inverse-focus-1, 0 0 3px #0176d3);
  outline: 0;
}
.slds-input_height {
  min-height: calc(1.875rem + (1px * 2));
