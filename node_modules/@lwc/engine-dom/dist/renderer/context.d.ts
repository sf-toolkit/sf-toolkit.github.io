import type { WireAdapterConstructor, WireContextValue, WireContextSubscriptionPayload, WireContextSubscriptionCallback } from '@lwc/engine-core';
 ...
 */
export declare function createContextProvider(adapter: WireAdapterConstructor): import("@lwc/engine-core").WireContextProvider;
