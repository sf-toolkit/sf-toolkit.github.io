...
declare function setProperty<K extends string>(node: Node & Record<K, unknown>, key: K, value: unknown): void;
...
declare function getStyle(elm: HTMLElement): CSSStyleDeclaration;
